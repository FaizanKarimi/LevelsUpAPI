...
{
    /// <summary>
    /// JsonResponseOutputFormatter class
    /// </summary>
    /// <seealso cref="TextOutputFormatter" />
    public class JsonResponseOutputFormatter : TextOutputFormatter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonResponseOutputFormatter"/> class.
        /// </summary>
        public JsonResponseOutputFormatter()
        {
            this.SupportedMediaTypes.Add(MediaTypeHeaderValue.Parse(ContentTypes.Json));
        ...
        public override Task WriteResponseBodyAsync(OutputFormatterWriteContext context, Encoding selectedEncoding)
        {
            ...
            {
                buffer = JsonSerializerHelper.Serialize<BasicResponse>(context.Object as BasicResponse);
            }
